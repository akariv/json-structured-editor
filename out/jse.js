...
(function() {
  var JSE, JSEArray, JSEBoolean, JSEDate, JSENumber, JSEObject, JSESelect, JSEString, JSEText, JSEValue, generateJSEItem, iced,
    __slice = [].slice,
  ...
  JSEValue = (function() {
    ...
    JSEValue.prototype.validate = function(value) {
      if (!(this.optional || (value != null))) {
        throw "JSE: " + this.title + " Required mandatory value";
      }
    ...
    JSENumber.prototype.validate = function(obj) {
      if (JSENumber.__super__.validate.call(this, obj)) {
        if (!(typeof obj === "number")) {
          throw "JSE: " + this.title + " Expected Number value";
        } else {
          return true;
        }
      }
  ...
  JSEBoolean = (function(_super) {

    __extends(JSEBoolean, _super);
    ...
    JSEBoolean.prototype.validate = function(obj) {
      if (JSEBoolean.__super__.validate.call(this, obj)) {
        if (!(typeof obj === "boolean")) {
          throw "JSE: " + this.title + " Expected Boolean value";
        } else {
          return true;
        }
      }
  ...
  generateJSEItem = function(fielddesc) {
    ...
    switch (type) {
      ...
      case "bool":
        return new JSEBoolean(optional, title, fixed);
      case "str":
